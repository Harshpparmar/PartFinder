...
const MotherboardDataTable = ({ motherboardData }) => {
  return (
              ...
              {motherboardData.map((motherboard, index) => (
                <tr key={index} className="block border-b lg:table-row ">
                  ...
                  <td className="block px-2 py-2 text-right sm:px-4 sm:py-3 lg:table-cell">
                    ...
                    <a href={motherboard.buyLink} className="rounded bg-blue-500 px-3 py-1 text-xs font-medium text-white hover:bg-blue-600 sm:text-sm">ADD</a>
                  </td>
                </tr>
              ))}
            </tbody>
