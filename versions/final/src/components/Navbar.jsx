        ...
        <header className="w-full">
                    ...
                    <nav className="hidden md:flex md:items-center md:space-x-8">
                        ...
                        <div className="relative" ref={productsDropdownRef}>
                            ...
                            <div className={`absolute left-0 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${productsDropdownOpen ? '' : 'hidden'}`}>
                                <div className="py-1">
                                    <Link to="/components/cpu" className="block px-4 py-2 text-left text-gray-700 hover:bg-gray-100" onClick={handleDropdownItemClick}>CPU</Link>
                        ...
                        <Link to="/complete-build" className="font-medium text-gray-900 hover:text-gray-700">Complete Builds</Link>
                        <Link to="/guide" className="font-medium text-gray-900 hover:text-gray-700">Guides</Link>
                    </nav>
            ...
            <div className={`md:hidden ${mobileMenuOpen ? '' : 'hidden'}`} id="mobile-menu-container">
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <Link to="/complete-build" className="block rounded-md px-3 py-2 text-left text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900">Complete Builds</Link>
                    <Link to="/guide" className="block rounded-md px-3 py-2 text-left text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900">Guides</Link>
                </div>
            </div>
        </header>
    );
