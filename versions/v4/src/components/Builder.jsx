  ...
  return (
    <>
      <div className="container mx-auto px-4 lg:px-0">
        <h1 className="text-4xl font-bold py-8 text-center bg-comet-900 text-white mb-4">Chose PC Parts</h1>
            ...
            <tbody className="max-h-[calc(100vh-200px)]">
              ...
              <td className="block px-4 py-3 md:table-cell md:px-6 md:py-4 md:text-right">
                <button
                  ...
                  onClick={() => window.location.href = '/components/cpu'}
                >
              ...
              <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/cooler'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              ...
              <tr className="block border-b border-opacity-20 md:table-row dark:border-gray-300 dark:bg-gray-50">
                ...
                <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/motherboard'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              ...
              <tr className="block border-b border-opacity-20 md:table-row dark:border-gray-300 dark:bg-gray-50">
                ...
                <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/memory'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              ...
              <tr className="block border-b border-opacity-20 md:table-row dark:border-gray-300 dark:bg-gray-50">
                ...
                <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/storage'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              ...
              <tr className="block border-b border-opacity-20 md:table-row dark:border-gray-300 dark:bg-gray-50">
                <td className="block px-4 py-3 text-xl font-semibold hover:underline md:table-cell md:px-6 md:py-4 md:text-base">
                  <a href="/components/video-card">Video Card</a>
                </td>
                <td className="block px-4 py-3 md:table-cell md:px-6 md:py-4 md:text-right">
                <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/video-card'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              ...
              <tr className="block border-b border-opacity-20 md:table-row dark:border-gray-300 dark:bg-gray-50">
                ...
                <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/case'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
              ...
              <tr className="block border-b border-opacity-20 md:table-row dark:border-gray-300 dark:bg-gray-50">
                ...
                <button
                  className="flex items-center rounded bg-blue-600 px-4 py-2 font-bold text-white shadow-md hover:bg-blue-700"
                  onClick={() => window.location.href = '/components/power-supply'}
                >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-2 h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
